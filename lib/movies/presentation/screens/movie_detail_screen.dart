...
import '../controller/bloc/movie_detail_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<MovieDetailBloc>()
        ...
        ..add(GetRecommendsEvent(id)),
      child: const Scaffold(
        body: SafeArea(child: MovieDetailContent()),
      ),
    );
  }
}
...
class MovieDetailContent extends StatelessWidget {
    ...
    return CustomScrollView(
      slivers: [
            ...
            background: FadeIn(
              ...
              child: ShaderMask(
                ...
                child: BlocBuilder<MovieDetailBloc, MovieDetailState>(
                  ...
                  return previous.movieDetailState != current.movieDetailState;
                  ...
                  switch (state.movieDetailState) {
                    ...
                    case RequestState.success:
                      return CachedNetworkImage(
                        ...
                        imageUrl:
                            AppConst.imageUrl(state.movieDetail!.backdropPath),
                        fit: BoxFit.fill,
                      );
                  }
                }),
        ...
        SliverPadding(
          ...
          sliver: SliverToBoxAdapter(child: _showRecommendations()),
        ),
      ],
    );
  }
  ...
  Widget _showRecommendations() {
    return BlocBuilder<MovieDetailBloc, MovieDetailState>(
      buildWhen: (previous, current) {
        return previous.recommendsState != current.recommendsState;
      },
      builder: (context, state) {
        switch (state.recommendsState) {
          case RequestState.idle:
            return const SizedBox(
              height: 400,
              child: Center(
          ...
          case RequestState.error:
            return SizedBox(
              height: 400,
              child: Center(
                child: Text(state.recommendsMessage),
              ),
            );
            ...
            return SizedBox(
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  final recommendation = state.recommends![index];
                  return FadeInUp(
                    from: 20,
                    duration: const Duration(milliseconds: 500),
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        imageUrl:
                            AppConst.imageUrl(recommendation.backdropPath!),
